...
Fehlers abgebrochen werden.}{Dies soll dem Spieler / der Spielerin ein gutes Spielerlebnis offenbaren.}{-A}{-}
...
\footnotetext[5]{GODOT Implementierung übernommen aus \textcolor{blue}{\href{https://docs.godotengine.org/en/stable/contributing/development/core_and_modules/godot_architecture_diagram.html}{docs.godotengine.org}}}
\footnotetext[6]{Aufbau der Datenklasse aus \textcolor{blue}{\href{https://www.researchgate.net/figure/Class-diagram-of-the-database-management-module_fig4_357706024}{researchgate.net}}}
